  ...
  return (
    ...
    >
      <div className='modal-wrapper'>
        <div
          id='modal'
          className={`modal bg-[var(--bs-bg-color)] text-[var(--bs-text-color)] ${
            isShowModal ? 'modal-open' : 'modal-close'
          }`}
        >
          <div className='modal-header border-b border-b-[var(--bs-border-color)]'>
            <div className='w-full flex justify-between m-4'>
              ...
              <a
                href='#'
                className='hover:bg-[var(--bs-toggle-button-hover)] py-1 px-2 rounded-md'
          ...
          <div
            id='modal-footer'
            className='flex w-full justify-end border-t border-t-[var(--bs-border-color)] p-3 gap-2'
          >
            <button
              className='hover:bg-[var(--bs-border-color)] p-2 rounded-lg'
              onClick={handleCloseClick}
            >
              Close
            </button>
            <button
              className='bg-[#0784c3] text-white p-2 rounded-lg'
              onClick={handleCloseClick}
            >
              Save Changes
            </button>
        ...
        <div className='ground-panel' onClick={handleCloseClick}></div>
      </div>
    </div>
  );
};
