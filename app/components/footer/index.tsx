      ...
      <div className="container-xxl">
        <div className="flex justify-between lg:w-full md:items-center md:flex py-6">
          <div className="flex justify-between w-full">
            ...
            <div>
              <p
                className="text-[var(--bs-text-color)] hover:text-[#066a9c] text-sm cursor-pointer"
        ...
        <div className="row md:justify-between py-8 border-t border-t-[--bs-border-color] border-b border-b-[--bs-border-color]">
          <div className="min-[992px]:w-1/3 min-[992px]:mb-0 xl:pr-16 mb-4">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl mb-0 ml-3">Powered by Ethereum</span>
            </div>
            <p className="text-xs">
            ...
            <div className="mt-2 hidden md:block">
              {theme == "light" ? (
                <Image src="/imgs/map.png" alt="Map" width={280} height={100} />
              ) : (
                <Image
                  src="/imgs/map-light.png"
                  alt="Map"
                  width={280}
                  height={100}
                />
          ...
          <div className="min-[992px]:flex-[1_0_0%] md:flex-[0_0_auto] md:w-1/3 md:mb-0 flex-[0_0_auto] w-1/2 mb-10">
            <h4 className="text-4 font-medium mb-1">Company</h4>
            <ul>
              <li className="py-1">
          ...
          <div className="min-[992px]:flex-[1_0_0%] md:flex-[0_0_auto] md:w-1/3 md:mb-0 flex-[0_0_auto] w-1/2 mb-10">
            <h4 className="text-4 font-medium mb-1">Community</h4>
            <ul>
              <li className="py-1">
                <a href="#" className="text-xs footer-menu">
                  API Documentation
          ...
          <div className="min-[992px]:flex-[1_0_0%] md:flex-[0_0_auto] md:w-1/3 flex-[0_0_auto] w-1/2">
            <h4 className="text-4 font-medium mb-1">Products & Services</h4>
            <ul>
              <li className="py-1">
                <a href="#" className="text-xs footer-menu">
                  Advertise
        ...
        <div className="flex justify-between py-4 lg:w-full md:items-center md:flex">
          <div className="flex justify-between w-full">
            <div>
              <p className="mb-0 text-xs">Etherscan © 2024 (A1)</p>
            </div>
            <div>
              <p className="mb-0 text-xs">
                ...
                <i
                  className="fa fa-heart text-[#de4437]"
                  aria-hidden="true"
                ></i>
              </p>
            </div>
