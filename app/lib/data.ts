...
import { faSun, faMoon, faStarAndCrescent, faArrowsRotate, faDownload, faFileInvoiceDollar, faGasPump, faArrowRightArrowLeft, faServer, faSignsPost, faMagnifyingGlassChart, faShield, faSignature, faMessage, faFilter } from '@fortawesome/free-solid-svg-icons';
...
export const navbarData: NavMenuType[] = [
  {
    ...
    data: [
      ...
      { label: "Pending Transactions", subLabel: null, icon: null, badge: null },
      { label: "Contract Internal Transactions", subLabel: null, icon: null, badge: null },
      ...
      { label: "Forked Blocks (Reorgs)", subLabel: null, icon: null, badge: null },
  ...
  },
  {
    ...
    data: [
      ...
      { label: "Similar Contract Search", subLabel: null, icon: null, badge: null },
      { label: "Smart Contract Search", subLabel: null, icon: null, badge: null },
      { label: "Contract Diff Checker", subLabel: null, icon: null, badge: null },
      { label: "", subLabel: null, icon: null, badge: null },
      { label: "Vyper Online Compiler", subLabel: null, icon: null, badge: null },
      { label: "Bytecode to Opcode", subLabel: null, icon: null, badge: null },
      { label: "Broadcast Transaction", subLabel: null, icon: null, badge: null },
    ]
  }
]
...
export const navMoreData: NavMenuType[] = [
  {
    label: "Tools",
    data: [
      { label: "Unit Converter", subLabel: null, icon: faArrowsRotate, badge: null },
      { label: "CSV Export", subLabel: null, icon: faDownload, badge: null },
      { label: "Account Balance Checker", subLabel: null, icon: faFileInvoiceDollar, badge: null },
    ]
  },
  {
    label: "Explore",
    data: [
      ...
      { label: "DEX Tracker", subLabel: null, icon: faArrowRightArrowLeft, badge: null },
      { label: "Node Tracker", subLabel: null, icon: faServer, badge: null },
      { label: "Label Cloud", subLabel: null, icon: faSignsPost, badge: null },
      { label: "Domain Name Lookup", subLabel: null, icon: faMagnifyingGlassChart, badge: null },
    ]
  },
  {
    label: "Services",
    data: [
      { label: "Token Approvals", subLabel: null, icon: faShield, badge: "Beta" },
      { label: "Verified Signature", subLabel: null, icon: faSignature, badge: null },
      { label: "Input Data Messages (IDM)", subLabel: null, icon: faMessage, badge: "Beta" },
      { label: "Advanced Filter", subLabel: null, icon: faFilter, badge: "Beta" },
      { label: "Blockscan Chat", subLabel: null, icon: faMessage, badge: "Beta" }
    ]
  }
]
...
export const chainlinkEthUsdAbi = [
  ...
  },
  {
    ...
    outputs: [{ name: "answer", type: 'int256' }, { name: "updatedAt", type: 'int256' }],
  },
] as const
